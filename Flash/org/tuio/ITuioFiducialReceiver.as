package org.tuio
{
	...
	public interface ITuioFiducialReceiver
	{
		 ...
		 * 
		 */
		function onAdd(event:TuioFiducialEvent):void;
		 ...
		 * 
		 */
		function onNotifyRemoved(event:TuioFiducialEvent, timeout:Number):void;
		 ...
		 * @see onRemove
		 */
		function onNotifyReturned(event:TuioFiducialEvent):void;
		 ...
		 * @see onRemove
		 */
		function onRemove(event:TuioFiducialEvent):void;
		 ...
		 * 
		 */
		function onMove(event:TuioFiducialEvent):void;
		 ...
		 * 
		 */
		function onRotate(event:TuioFiducialEvent):void;
	}
}